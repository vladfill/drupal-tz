	...
	<header>
		<div class="container">
			<div class="row">
				...
				<a href="?active=allPosts"class="button" data-nav="allPosts"><span>Редактировать</span></a>
				<a href="?active=newPost" class="button" data-nav="newPost"><span>Добавить стаью</span></a></p></div>
			</div>
		</div>
	</header>
